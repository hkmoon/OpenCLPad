...
import view.display.OpenCLPadDisplayView;
...
public class OpenCLPadApplicationModel extends AbstractApplicationModel {
    ...
    private OpenCLPadDisplayView iddeaView;

    /** Creates a new instance. */
    public OpenCLPadApplicationModel() {
    }
    ...
    protected MenuBuilder createMenuBuilder() {
        return new OpenCLPadMenuBuilder();
    }
    ...
    public void initView(Application a,View p) {
        if (a.isSharingToolsAmongViews()) {
            ((OpenCLPadDisplayView) p).setEditor(getSharedEditor());
            iddeaView = ((OpenCLPadDisplayView) p);
        }
    }

    public OpenCLPadDisplayView getDisplayView()
    {
        return iddeaView;
    }
    ...
    public List<JToolBar> createToolBars(Application a, @Nullable View pr) {
        ...
        OpenCLPadDisplayView p = (OpenCLPadDisplayView) pr;
